...
# Example:
# python -m spinup.run ra_ppo --hid "[64,64]" --env dubins_car-v0 --exp_name installtest --epochs 2000 --max_ep_len 10 --gamma 0.99999
...
BASE_ALGO_NAMES = ['vpg', 'ra_vpg', 'ra_ppo', 'trpo', 'ppo', 'ddpg', 'td3', 'sac']
